...
{
	char *op_type;
	int (*op_func)(va_list arg_list, char *buffer, char buffer_i, Format_flag_t *flags);
} type_to_func_t;
...
int add_int_buff(unsigned int, char *buffer, char buffer_i);
/* int cp_to_flag_buffer(const char *src_ptr, int byte_c, Format_flag_t *flags_buffer); */
int handle_char_format(va_list arg_list, char *buffer, char buffer_i, Format_flag_t *flags);
int handle_str_format(va_list arg_list, char *buffer, char buffer_i, Format_flag_t *flags);
int handle_int_format(va_list arg_list, char *buffer, char buffer_i, Format_flag_t *flags);
int handle_float_format(va_list arg_list, char *buffer, char buffer_i, Format_flag_t *flags);
int handle_percent_format(va_list arg_list, char *buffer, char buffer_i, Format_flag_t *flags);
int handle_bin_format(va_list arg_list, char *buffer, char buffer_i, __attribute__((unused)) Format_flag_t *flags);
int (*get_format_handler(char *spec))(va_list arg_list, char *, char , Format_flag_t *flags);
int print_buffer(char *buffer, int byte_count);
